...
/**
 * EditBinderCover — visual customisation for a binder (color, text, image).
 *
 * NOTE: The "make public" / share-link UI used to live here too, but it was
 * confusing to bury sharing inside a screen named "Edit Cover" and the
 * double-source-of-truth could race with the dedicated ShareBinderModal.
 * Sharing now lives only in ShareBinderModal, triggered by the Share button
 * on the BinderView header and on each card in BindersView.
 *
 * Cover images are uploaded to Supabase Storage by the parent (DashboardShell).
