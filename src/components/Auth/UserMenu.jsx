      ...
      {open && (
        <div style={{
          ...
          <div style={{ padding: '14px 16px', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <div style={{ fontSize: '0.8rem', opacity: 0.55, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              {user?.email}
            </div>
          </div>
          ...
          <div style={{ padding: '6px' }}>
            <MenuButton icon={<User size={16} />} label="Profile" onClick={() => { setOpen(false); navigate('/profile'); }} />
            <MenuButton
